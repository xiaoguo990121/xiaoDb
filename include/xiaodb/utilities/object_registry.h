...
namespace XIAODB_NAMESPACE
{
    ...
    public:
        ...
        private:
            enum Quantifier
            {
                kMatchZeroOrMore, // [suffix].*  后面可以有0或更多字符
                kMatchAtLeastOne, // [suffix].+  后面必须至少有1个字符
                kMatchExact,      // [suffix]    精确匹配
                kMatchInteger,    // [suffix][0-9]+ 后面必须是整数
                kMatchDecimal,    // [suffix][0-9]+[.][0-9]+ 后面必须是小数
            };
