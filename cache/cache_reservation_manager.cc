...
namespace XIAODB_NAMESPACE
{
    ...
    CacheReservationManagerImpl<R>::CacheReservationHandle::CacheReservationHandle(
        ...
        std::shared_ptr<CacheReservationManagerImpl> cache_res_mgr) : incremental_memory_used_(incremental_memory_used)
    {
    ...
    CacheReservationManagerImpl<R>::CacheReservationManagerImpl(
        std::shared_ptr<Cache> cache, bool delayed_decrease) : cache_(cache),
