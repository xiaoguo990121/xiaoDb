...
#include "xiaodb/utilities/object_registry.h"
#include "xiaodb/utilities/options_type.h"
...
namespace XIAODB_NAMESPACE
{
    ...
    namespace
    {
        ...
        {
        private:
            size_t prefix_len_;  // 前缀长度
            std::string id_; // 转换的唯一标识符
        ...
        public:
            ...
            static const char *kClassName() { return "xiaodb.FixedPrefix"; }
        ...
        public:
            ...
            static const char *kClassName() { return "xiaodb.CappedPrefix"; }
        ...
        public:
            ...
            static const char *kClassName() { return "xiaodb.Noop"; }
            const char *Name() const override { return kClassName(); }
    ...
    Status SliceTransform::CreateFromString(const ConfigOptions &config_options, const std::string &value,
    ...
    // most if the code is for validation/error check
    int fromHex(char c)
    {
        // toupper:
        if (c >= 'a' && c <= 'f')
    ...
    std::string Slice::ToString(bool hex) const
    {
        ...
        if (hex)
        {
            ...
            for (size_t i = 0; i < size_; ++i)
            {
                ...
                result.push_back(toHex(c >> 4)); // 一个字节需要用两个十六进制字符来表示
    ...
    // Originally from xiaodb/utilities/ldb_cmd.h
