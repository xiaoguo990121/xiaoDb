...
#define XIAODB_HAS_CPP_ATTRIBUTE(x) 0
#else
#define XIAODB_HAS_CPP_ATTRIBUTE(x) __has_cpp_attribute(x)
#endif

#if XIAODB_HAS_CPP_ATTRIBUTE(maybe_unused) && __cplusplus >= 201703L
#define XIAODB_MAYBE_UNUSED [[maybe_unused]]
#elif XIAODB_HAS_CPP_ATTRIBUTE(gnu::unused) || __GUNC__
#define XIAODB_MAYBE_UNSED [[gnu::unused]]
#else
#define XIAODB_MAYBE_UNUSED
#endif
...
namespace XIAODB_NAMESPACE
{
                          ...
                          bool fixed_format)
    {
        ...
        else if (micros < 10000001 * 60 * 60 && !fixed_format)
        {
    ...
    std::string BytesToHumanString(uint64_bytes)
    {
