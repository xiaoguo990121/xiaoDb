...
{
    // The file declares data structures and functions that deal with internal keys.
    ...
    // A range of user keys used internally by XiaoDB. Also see `Range` used by public APIs.
    struct UserKeyRange
    {
