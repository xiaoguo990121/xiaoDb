...
namespace XIAODB_NAMESPACE
{
    ...
    private:
        ...
        // The size of WAL is unknown, used when the WAL is not synced yet or is empty.
    ...
    // These tags are presisted to MANIFEST, so it's part of the user API.
    enum class WalAdditionTag : uint32_t
    {
        // Indicates that there aret no more tags.
        kTerminate = 1,
