...
#include "xiaodb/compaction_filter.h"
#include "xiaodb/convenience.h"
#include "xiaodb/filter_policy.h"
#include "xiaodb/flush_block_policy.h"
#include "xiaodb/memtablerep.h"
#include "xiaodb/merge_operator.h"
#include "xiaodb/options.h"
#include "xiaodb/rate_limiter.h"
        ...
        std::string *elem_name)
    {
        ...
        else
        {
            ...
            { // We found a separator
                ...
                if (siter != opt_map.end())
                {                                   // We found the short name
                    if (siter->second.IsStruct() || // If the object is a struct
                        siter->second.IsConfigurable())
                    {                                          // or a Configurable
